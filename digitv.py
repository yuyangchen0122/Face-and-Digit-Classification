...
for pp in range(1,11):
    percent = pp
    lable=[l[:-1] for l in open("digitdata/testlabels").readlines()]
    image_length = 28
    all=[l[:-1] for l in open("digitdata/testimages").readlines()]
    total = len(lable)
    ...
    new_lable=[l[:-1] for l in open("digitdata/validationlabels").readlines()]
    new_total = len(new_lable)

    #load image from test
    new_all=[l[:-1] for l in open("digitdata/validationimages").readlines()]
