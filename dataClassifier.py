...
def enhancedFeatureExtractorDigit(datum):
  ...
  """
    ...
    for i in range(starting_column, ending_column + 1):
        ...
        #   if k != previous - current:
        #     features[('black', 0, 0, i - 1 - starting_row, i - starting_row, k)] = 0
...
def runClassifier(args, options):
    ...
    stopping_time = timeit.default_timer()
    print("The total training time is: ", stopping_time - starting_time)
    print("Validating...")
